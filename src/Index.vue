    ...
    <div>
                        ...
                        <div class="mobile-menu ">
                            ...
                            <div class="mobile-menu__sidebar-menu">
                                ...
                                <ul class="page-dropdown-menu">
                                    ...
                                    <li class="dropdown-list"><a href="#0"> <span>Features </span> <span
                                            class="menuarrow">
                                            <i class="flaticon-next-1"></i> </span> </a>
                                        <ul class="dropdown">
                                            <li class="subhed position-relative"><a href="#0"> <span>Category</span>
                                                <span
                                            ...
                                            <li class="subhed position-relative"><a href="#0"> <span>Discount</span>
                                                <span
                                                        class="menuarrowtwo"> <i class="flaticon-next-1"></i> </span>
                                            </a>
                                                <ul class="subdropdown">
                                    ...
                                    <li class="dropdown-list"><a href="#0"> <span>Pages</span> <span class="menuarrow"> <i
                                        ...
                                        <ul class=" dropdown ">
                                            ...
                                            <li><a href="shop-list-left-sidebar.html"> Shop List Left Sidebar </a></li>
                                            <li><a href="shop-grid-right-sidebar.html"> Shop List Right Sidebar </a>
                                            </li>
                                        </ul>
                                    </li>
                    ...
                    <div class="d-lg-block d-none">
                        <div class="row g-0 position-relative">
                            <div class="col-lg-3 d-flex align-items-center justify-content-center border-rit ">
                                <div class="logo"><a href="index.html"> <img src="/src/assets/images/logo/logo.png"
                                                                             alt=""> </a>
                                </div>
                            </div>
                    ...
                    <div class="sidebar-textwidget">
                        <div class="sidebar-info-contents">
                            <div class="content-inner">
                                <div class="logo"><a href="index.html"><img src="/src/assets/images/logo/logo-2.png"
                                                                            alt=""></a>
                                </div>
        ...
        <footer class="footer-default footer-3 ">
            <div class="footer-default__shap_1 position-absolute "><img
                    src="/src/assets/images/shape/footer-shape-1.png"
                    alt=""></div>
            <!--Start Footer-->
