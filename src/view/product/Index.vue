                                                                ...
                                                                <div class="row justify-content-between">
                                                                        ...
                                                                        <div class="quick-view__left-content">
                                                                            <div class="tabs">
                                                                                <div class="popup-product-thumb-box">
                                                                                    <ul>
                                                                                        <li v-for="image in popupProduct.image"
                                                                                ...
                                                                                <div class="popup-product-main-image-box">
                                                                                    <div v-for="image in popupProduct.image">
                                                                                        <div :id="`tabb${image.id}`"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="popup-right-content">
                                                                            ...
                                                                            <div class="price">
                                                                                <h2> {{ popupProduct.price }}р.
                                                                                    <del> {{ popupProduct.old_price }}р.</del>
                                                                                </h2>
                                                                                <h6> Оригинал</h6>
                                                                            </div>

                                                                            <template v-if="popupProduct.product_sub" >
                                                                                <div>
                                                                                    <a @click.prevent="getProduct(prosub.id)" v-for="prosub in popupProduct.product_sub" href="#0" class="" style="width:20px; height:20px;">
                                                    ...
                                                    <div class="product-grid-two list mt-30">
                                                        <div class="product-grid-two__img">
                                                            <a href="shop-details-2.html" class="d-block">
                                                                <img src="/src/assets/images/home-three/products-2.jpg"
                                                                     alt=""/>
                                                            </a></div>
                                                        <div id="popup2z"
                                                             class="product-gird__quick-view-popup mfp-hide">
                                                ...
                                                <div class="col-12">
                                                    <div class="product-grid-two list mt-30">
                                                        <div class="product-grid-two__img"><a href="shop-details-2.html"
                                                                                              class="d-block">
                                                            <img src="/src/assets/images/home-three/products-4.jpg"
                                                                 alt=""/>
                                                        </a>
                                                            <div class="products-grid-one__badge-box"> <span
