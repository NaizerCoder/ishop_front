                        ...
                        <div class="col-xl-6 col-lg-6 mt-30 wow fadeInUp animated">
                            <div class="shop-details-top-right ">
                                <div class="shop-details-top-right-content-box">
                                    ...
                                    <p class="shop-details-top-product-sale"><span>{{ product.count }}</span> шт. на
                                        складе
                                    </p>
                                    ...
                                    <div class="shop-details-top-color-sky-box">
                                        <h4>Цвет: {{ titleColor }}</h4>
                                        <ul class="varients">
                                            <li v-for="color in product.colors">
                                                <a @click.prevent="addColor(color.title)" href="#0" class="shop-details-top-color-sky-img" :style="`background-color:#${color.code}`">
            ...
            <section class="product pt-60 pb-60 wow fadeInUp overflow-hidden ">
                <div class="container">
                    <div class="row wow fadeInUp animated">
                        <div class="col-12">
                            <ul class="nav product-details-nav nav-one nav-pills justify-content-center"
                                id="pills-tab-two"
                                role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-sizechart-tab"
                                            data-bs-toggle="pill" data-bs-target="#pills-sizechart" type="button"
                                            role="tab"
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-8 mt-30">
                                            ...
                                            <ul class="drescription-list">
                                                ...
                                                <li> 2. Euismod disagree soler imperdiet vehicula pede eros ipsum cras
                                                    mi
                                                    feugiat.
                                                </li>
                                                <li> 3. Rhoncus consequat phasellus donec suspendisse scelerisque
                                                    facilisis
                                                    gravida porttitor turpis.
                                                </li>
                                                <li> 4. Consequat phasellus donec suspendisse scelerisque facilisis
                                                    gravida
                                                    porttitor turpis.
                                                </li>
                                                <li> 5. Consequat phasellus donec suspendisse scelerisque facilisis
                                                    gravida
                                                    porttitor
                                                </li>
                                            </ul>
                            ...
                            <div class="tab-pane fade" id="pills-additional" role="tabpanel"
                                ...
                                <div class="product-drescription">
                                    <p class="pt-0"> Assertively conceptualize parallel process improvements through
                                        ...
                                        forward testing procedures with accurate quality vectors. Globally aiembrace
                                        ethical
                                        functionalities via empowered scenarios. Phosfluorescently restore highly
                                        efficient
                                        opportunities and client-focused infomediaries. Enthusiastically transition
                                    ...
                                    <div class="review-single">
                                        <div class="left">
                                            ...
                                            <p> Assertively conceptualize parallel process improvements through user
                                                friendly colighue to action items. Interactively antidos cultivate
                                                interdependent customer service without clicks-and-mortar
                                                e-services. </p>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="ratting-box">
                                                        <p> RATING </p>
                                                        <div class="ratting"><i class="flaticon-star-1"></i> <i
                                                                class="flaticon-star-1"></i> <i
                                                                class="flaticon-star-1"></i>
                                                            <i class="flaticon-star-1"></i> <i
                                                                    class="flaticon-star-1"></i>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group"><label for="namee"> REVIEW TITLE</label>
                                                        <input
                    ...
                    <div class="row mt-30 wow fadeInUp animated">
                        <div class="catagory-slider">
                            ...
                            <div class="products-grid-one">
                                <div class="products-grid-one__product-image">
                                    <div class="products-grid-one__badge-box"> <span
                                            class="bg_black badge discount">-20%</span></div>
                                ...
                                <div class="products-grid-one__thumb-box">
                                    <p class="products-grid-one__product-varient"><span class="color"> Yellow </span>
                                        <img
                                    ...
                                    <p class="products-grid-one__product-varient"><span class="color"> Black </span>
                                        <img
                            ...
                            <div class="products-grid-one">
                                <div class="products-grid-one__product-image">
                                    <div class="products-grid-one__badge-box"><span
                                            class="bg_base badge new ">New</span>
                                        <span class="bg_black badge discount">-30%</span></div>
                                    <a
                            ...
                            <div class="products-grid-one">
                                ...
                                <div class="products-grid-one__thumb-box">
                                    ...
                                    <p class="products-grid-one__product-varient"><span class="color"> green </span>
                                        <img
...
export default {
    ...
    methods: {
        getProduct() {
            this.axios.get(`http://ishop/api/products/${this.$route.params.id}`)
                .then(res => {
